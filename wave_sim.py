...
class Water:
    def __init__(self):
        ...
        self.initial_speed = 300 # NOTA: Passar a ser calculada em relação à massa e altura de lançamento do objeto
    ...
    def spring_list(self):
        for x in range(self.x_origin, self.x_end, self.spring_width):
            self.springs.append(Springs(x, self.target_height, self.spring_width))
